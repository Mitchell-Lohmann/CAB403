...
int main(int argc, char **argv)
{
    ...
    char *full_addr = argv[4];
    char firealarm_addr[10];
    int firealarm_port = split_Address_Port(full_addr, firealarm_addr);
    ...
    memcpy(datagram.header, "FIRE", sizeof(datagram.header));
    ...
    destaddr.sin_port = htons(firealarm_port);
    ...
    {// Loop starts
        ...
        {
            // Sends UDP Datagram
            sendto(sendfd, datagram.header, strlen(datagram.header), 0, (const struct sockaddr*)&destaddr, destaddr_len);
